...
public class StudentInfo extends javax.swing.JFrame {
    ...
    public void getStudentData(Students s){
        jLabel2.setText(s.getStudent_name());
        jLabel4.setText(s.getFather_name());
        jLabel6.setText(s.getRegisterationNO());
        jLabel8.setText(s.getDate_Of_Birth());
        jLabel10.setText(s.getSection());
        jLabel12.setText(s.getGender());
        jLabel14.setText(s.getCategory());
    }
    /**
